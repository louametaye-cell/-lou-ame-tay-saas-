...
// Initial Seed Tenants (Scaler 1000)
export const DEFAULT_TENANTS: SaaSTenant[] = [
  {
    id: 'tenant_starter_01',
    businessName: 'Le Petit Maquis - Starter Test',
    subdomain: 'petitmaquis',
    ...
    subscriptionExpiresAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 30).toISOString(),
  ...
  {
    id: 'tenant_pro_01',
    businessName: 'Chez Fatou & Frères - Thiès Gourmet',
    subdomain: 'chezfatou',
    ...
    subscriptionStatus: 'ACTIVE',
    subscriptionExpiresAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 15).toISOString(),
  ...
  {
    id: 'tenant_premium_01',
    businessName: 'Le Palmier Gourmand & Resort - Saly',
    subdomain: 'palmiersaly',
    ownerName: 'Ibrahima Sarr',
    phone: '+221 78 987 65 43',
    address: 'Zone Touristique de Saly',
    city: 'Saly Portudal',
    currentPlanId: 'plan_premium',
    subscriptionStatus: 'ACTIVE',
    subscriptionExpiresAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 60).toISOString(),
  ...
  {
    id: 'tenant_past_due_01',
    businessName: 'Teranga Grill & Fast-Food',
    subdomain: 'terangagrill',
    ...
    subscriptionExpiresAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2).toISOString(),
  ...
  {
    id: 'tenant_suspended_01',
    businessName: 'La Pergola Bleue',
    subdomain: 'pergolableue',
