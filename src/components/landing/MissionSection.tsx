...
import { Globe, RefreshCw, Leaf, Flag, ArrowRight, ShieldCheck } from 'lucide-react';
  ...
  const missionPillars = [
    {
      id: 'pillar-1',
      icon: Globe,
      iconBg: 'bg-emerald-500/10 text-[#00A86B]',
    ...
    },
    {
      id: 'pillar-2',
      icon: RefreshCw,
      iconBg: 'bg-amber-500/10 text-[#FF6B00]',
      badge: 'Zéro Papier',
    ...
    },
    {
      id: 'pillar-4',
      icon: Flag,
      iconBg: 'bg-green-500/10 text-emerald-700',
    ...
    <section id="vision-mission" className="py-20 bg-gradient-to-b from-white via-[#F8F9FA] to-white border-b border-gray-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-[#00A86B] text-xs font-bold uppercase tracking-wider">
          ...
          <p className="text-base sm:text-lg text-gray-600 font-normal leading-relaxed max-w-3xl mx-auto">
            <strong>Lou Ame Tay ?</strong> est la plateforme SaaS 100% sénégalaise conçue pour accompagner la modernisation de notre hospitalité. 
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {missionPillars.map((pillar) => {
            ...
            return (
              <div
                key={pillar.id}
                className={`bg-white rounded-2xl p-6 border ${pillar.colorBorder} shadow-sm hover:shadow-md transition-all flex flex-col justify-between group hover:-translate-y-1`}
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className={`p-3 rounded-xl ${pillar.iconBg} group-hover:scale-110 transition-transform`}>
        ...
        <div className="mt-12 max-w-4xl mx-auto bg-white border-2 border-emerald-500/20 rounded-2xl p-6 sm:p-8 shadow-lg text-center relative">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <a
              ...
              className="bg-[#00A86B] hover:bg-[#00925d] active:scale-95 text-white px-6 py-3.5 rounded-xl font-bold text-xs sm:text-sm shadow-md transition-all shrink-0 flex items-center gap-2"
            >
